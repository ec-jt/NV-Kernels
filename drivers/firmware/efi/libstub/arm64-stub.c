				 ...
				 efi_handle_t image_handle)
{
	...
	*reserve_size = kernel_memsize;
	...
	/*
	 * Query D-CRTM for required DLME data size via DRTM_FEATURES.
	 * Reserve that much space after kernel BSS for D-CRTM to
	 * populate DLME data (address map, event log, etc.).
	 */
